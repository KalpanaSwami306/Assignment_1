 ...
 * Binary to Decimal,Octal and Hexadecimal           * Decimal to Binary,Octal and Hexadecimal
 * Octal to  Binary,Hexadecimal and Decimal          * Hexadecimal to Binary,Octal and Decimal
...
public class NumberOperation {
    ...
    do{
        ...
        System.out.println(constant.EXECUTE1);
